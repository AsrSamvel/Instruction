...
## Какой-то новый заголовок для конфликта

Пропишем тут текст. Добавим ещё текст для конфликта

Ну хочу, чтоб был конфликт

Добавляем сюда текст для конфлитка и вернемся к нему через чекаут 
